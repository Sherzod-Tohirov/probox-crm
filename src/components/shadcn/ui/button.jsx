  ...
  'inline-flex items-center justify-center gap-[8px] whitespace-nowrap cursor-pointer rounded-[12px] text-[14px] font-semibold transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--button-bg)] disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:h-[16px] [&_svg]:w-[16px] [&_svg]:shrink-0',
  {
    variants: {
      variant: {
        ...
        ghost:
          'border border-transparent bg-transparent text-[var(--secondary-color)] hover:bg-[var(--primary-table-hover-bg)] hover:text-[var(--primary-color)]',
