...
import { buildDateOptions } from '../utils/flatpickrOptions';
...
const DateInput = ({ includeTime, datePickerOptions = {}, value, defaultValue, onChange, commonProps }) => {
  ...
  return (
    <Flatpickr
      ...
      onChange={(dateArr) => {
        ...
        onChange?.(formatDateUI(date, !!includeTime));
      }}
