      ...
      <Card>
        ...
        <CardContent>
          <div
            ...
            style={{ borderColor: 'var(--primary-border-color)', color: 'var(--secondary-color)' }}
          >
            Xaridlar topilmadi
          </div>
        </CardContent>
        ...
        {contracts.map((contract, i) => {
          ...
          return (
            ...
            >
              ...
              <div className="flex items-center gap-[8px] text-[11px]" style={{ color: 'var(--secondary-color)' }}>
              ...
              <div className="flex items-center justify-between">
                <span className="text-[14px] font-bold" style={{ color: 'var(--primary-color)' }}>
                  {contract?.totalAmount ? formatterCurrency(contract.totalAmount) + ' uzs' : '—'}
                </span>
                <span className="text-[13px] font-medium" style={{ color: 'var(--secondary-color)' }}>
                  {contract?.totalPaid ? formatterCurrency(contract.totalPaid) + ' uzs' : '—'}
                </span>
              </div>
            </div>
          );
